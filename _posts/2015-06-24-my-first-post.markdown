...
<p>The folder titled "img" in your repo is where to place all of your images that you would like to be on the website! If you want to put them in the middle of the page like the example below, you must type in the following:
</p><textarea><a href="#">
